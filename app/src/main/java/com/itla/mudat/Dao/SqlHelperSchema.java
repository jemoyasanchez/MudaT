...
public class SqlHelperSchema {
    ...
    public static final String CONSTANTE_TABLE = "CREATE TABLE IF NOT EXISTS " + Constante.nomtableConstante + " ( " + Constante.nomip + " INTERGER PRIMARY KEY , " + Constante.nomid + " INTERGER);";
    public static final String MEGUSTA_TABLE = "CREATE TABLE IF NOT EXISTS " + MeGusta.nomtableMeGusta + " ( " + MeGusta.nomid + "  INTEGER PRIMARY KEY AUTOINCREMENT , " + MeGusta.nomusuario + " INTEGER , " + MeGusta.nomanuncio + " INTEGER  , " + MeGusta.nomgusta + " INTEGER  );";
    public static final String COMENTARIO_TABLE = "CREATE TABLE IF NOT EXISTS " + Comentario.nomcomentario + " ( " + Comentario.nomid + "  INTEGER PRIMARY KEY AUTOINCREMENT, " + Comentario.nomusuario + " INTEGER  , " + Comentario.nomanuncio + " INTEGER  , " + Comentario.nomcomentario + " TEXT  );";
